                    ...
                    <div class="space-y-4">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <x-text-input id="fornecedor" name="fornecedor" type="text" class="mt-1 block w-full" required />
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <x-text-input id="quantidade" name="quantidade" type="number" class="mt-1 block w-full" required />
                            </div>
                            <div>
                        ...
                        <div>
                            ...
                            <textarea name="descricao" class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm"></textarea>
                        </div>
